...
- **[Binder & run-modes](binder-and-modes.md)** — the binder capability ladder (host → loadable module → vm+KVM → vm+TCG) and the `beetroot modes` decision logic that picks a rung for the current host.
