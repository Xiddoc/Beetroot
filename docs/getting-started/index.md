...
2. **[Installation](installation.md)** — `uv tool install git+https://github.com/Xiddoc/Beetroot.git`, then `beetroot setup` to build the base image. (If you're hacking on Beetroot itself, see [CLAUDE.md](https://github.com/Xiddoc/Beetroot/blob/main/CLAUDE.md) for the editable `uv sync` workflow.)
